...
OBJS        += main.o init.o player.o title.o game.o gap.o score.o bg.o draw.o text.o unifont.o
              
HEADERS     += main.h init.h platform.h player.h title.h game.h gap.h score.h bg.h draw.h text.h unifont.h
